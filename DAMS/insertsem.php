...
$db=mysql_select_db("faculty",$con) or die("Failed to connect to MySQL: " . mysql_error());	
$username=$_SESSION['username1'];	
			$result = mysql_query("SELECT * FROM seminar WHERE username='$username'");
			?>
		<form  class="form" action="insertsem2.php"  method="post">
							<ul id="progressbar">
		<li class="active">Seminar Details</li>
		<li>Committee</li>
...
<!--<input type="text" value="<>" data-role="tagsinput" />-->
							...
							<tr><td style="width:200px;"><label>Name of Programme:</label></td>
								<td><input type="text" class="size3" name="namepr" data-validate="alpha,required" placeholder="seminar Name"></td></tr>
								<br/>
...
function daydiff(first, second) {
    return (second-first)/(1000*60*60*24);
				...
				<br/><table>
					<tr><td>No. of Days:</td><td><input type="text" name="dayinput" id="dayinput" disabled> </td></tr>
...
<table> <tr><td style="width:240px;"><label>Name of Convenor:</label></td>
								...
								<td><input type="text" class="size3" name="organisedept" placeholder="Name" data-validate="number,required"/><br/>
								</td></tr>
							</table>
