...
<html lang="en">
 <head>
    ...
    <title>Organized FDP/STTP</title>
   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
	...
	<div  role="main">
	  ...
	  <div id="sttp" class="container theme-showcase" role="main">
			...
			<form name="myform" role="form" action="rva_add_fdp1.php" method="post">		
								   ...
								   <div class="panel panel-default">
									  <div class="panel-heading">
										<h4 class="panel-title">
										  <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">FDP Details</a>
										</h4>
									  </div>
			...
			<div id="sttp" class="container theme-showcase" role="main">
			<form name="myform2" role="form" action="rva_add_sttp1.php" method="post">		
					  <div class="panel-group" id="accordion">
					   ...
					   <div class="panel panel-default">
						  <div class="panel-heading">
							<h4 class="panel-title">
							  <a data-toggle="collapse" data-parent="#accordion" href="#collapse11">STTP Details</a>
							</h4>
						  </div>
						  <div id="collapse11" class="panel-collapse collapse in">
							...
							<div class="form-group">
								...
								<div class="form-group">
								  <label for="thelist">Name of Technical Body involved:</label>
								  <select class="form-control" name="thelist" id="thelist" onclick="enableCC()">
									<option>Select:-</option>
									<option>ISTE</option>
									<option>AICTE</option>
									<option>DST</option>
						...
						<div class="panel panel-default">
						  <div class="panel-heading">
							<h4 class="panel-title">
							  <a data-toggle="collapse" data-parent="#accordion" href="#collapse22">Committee</a>
							</h4>
						  </div>
					   ...
					   <div class="panel panel-default">
						  <div class="panel-heading">
							<h4 class="panel-title">
							  <a data-toggle="collapse" data-parent="#accordion" href="#collapse33">Participants Details</a>
							</h4>
						  </div>
						...
						<div class="panel panel-default">
						  <div class="panel-heading">
							<h4 class="panel-title">
							  <a data-toggle="collapse" data-parent="#accordion" href="#collapse44">Speaker Details</a>
							</h4>
						  </div>
