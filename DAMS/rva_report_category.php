      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <?php
			...
			echo '<li><a href="">Event Report</a></li>';
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  ...
		  <h4></h4>
						...
						<form action="rva_report_preview.php" method="post">
						...
						<tbody>
							<tr>
								<th>Type of Event:</th>
								<td>
										 <div class="checkbox"><label><input type="checkbox" name="workshop"> Workshop&nbsp;&nbsp;&nbsp;&nbsp;</label></div>
										 <div class="checkbox"><label><input type="checkbox" name="seminar"> Seminar&nbsp;&nbsp;&nbsp;&nbsp;</label></div>
										 <div class="checkbox"><label><input type="checkbox" name="fdp"> FDP&nbsp;&nbsp;&nbsp;&nbsp;</label></div>
										 <div class="checkbox"><label><input type="checkbox" name="sttp"> STTP&nbsp;&nbsp;&nbsp;&nbsp;</label></div>
								</td>
							</tr>
							<tr>
								<th>Name of Event:</th>
