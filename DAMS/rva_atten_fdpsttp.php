  ...
  <head>
	...
	<script src="js/jquery.min.js"></script>
		<script>
									...
									<script type="text/javascript">
												...
												function cuncheck()
												{
													if(document.myform.fdpsttp.checked==true || 
													document.myform.name.checked==true || 
													document.myform.place.checked == true ||
													document.myform.date.checked == true ||
													document.myform.days.checked == true)								
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">FDP/STTP Report</h1>
		  <h4></h4>
						...
						<form name="myform" action="rva_atten_fdpsttp_preview.php" method="post">
                     ...
                     -->
						...
						<nav>
							<ul class="pager">
								...
								<a href="rva_fdpsttp_excel_1_A.php" class="btn btn-info" role="button">Excel Download</a>
							</ul>
						</nav>
						</form>
