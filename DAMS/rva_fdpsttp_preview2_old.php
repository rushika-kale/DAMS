	 ...
	 echo'
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			  ...
			  <h4 class="page-header"><center>Organized FDP/STTP Report</center></h4>';
									...
									$res=mysqli_query($con,"select * from organisedfdp where session='$session2012_13' or session='$session2013_14' or session='$session2014_15' or session='$session2015_16'
													 union
