...
$username=$_SESSION['username1'];	
			...
			?>
		<form  class="form" action="insertsttp2.php"  method="post">
							<ul id="progressbar">
...
<!--<input type="text" value="<>" data-role="tagsinput" />-->
							...
							<tr><td style="width:200px;"><label>Name of Programme:</label></td>
								<td><input type="text" class="size3" name="namepr" data-validate="alpha,required" placeholder="Faculty Development Program Name"></td></tr>
								<br/>
...
<fieldset>
		  <div id="room_fileds">
									...
									<div class="content">
										Name of Speaker: <input type="text" data-validate="required" name="s1name" class="size3" data-validate="alpha,required"/><br/>
