...
$username=$_SESSION['username1'];	
		...
		<form  class="form" action="insertwork2.php"  method="post">
							<ul id="progressbar">
		<li class="active">Workshop Details</li>
		<li>Committee</li>
...
<!--<input type="text" value="<>" data-role="tagsinput" />-->
								<table>						
							<tr><td style="width:200px;"><label>Name of Workshop:</label></td>
								<td><input type="text" class="size3" name="namepr" data-validate="alpha,required" placeholder="Workshop Name"></td></tr>
								<br/>
								<tr><td style="width:200px;"><label>Name of Technnical: Body Involved<label></td>
...
function daydiff(first, second) {
    return (second-first)/(1000*60*60*24);
				...
				<br/><table>
					<tr><td>No. of Days:</td><td><input type="text" name="dayinput" id="dayinput" readonly> </td></tr>
                				<tr><td>Role:</td><td><select name="organiser" class="size2" onChange="shift(this, 'field')">
								...
								function shift(organiser, field) {
									field = document.getElementById(field);
									var idx = organiser.selectedIndex;
									var content = organiser.options[idx].innerHTML;
                                    ...
                                    if(content=="coconvenor")
                                    {
                                        theinput.removeAttribute('disabled',true);
                                        theinput.value=="";
                                    }
                                    if(content=="coordiantor")
                                    {
                                        theinput.removeAttribute('disabled',true);
                                        theinput.value=="";
                                    }
                                    if(content=="cocoordinator")
                                    {
                                        theinput.removeAttribute('disabled',true);
                                        theinput.value=="";
                                    }
...
<table> <tr><td style="width:240px;"><label>Name of Convenor:</label></td>
								...
								<td><input type="text" class="size3" name="coconvenor"placeholder="Name"data-validate="alpha,required"><br/>
								</td></tr>
								<tr><td style="width:240px;"><label>Name of Co-ordinator:</label></td>
								<td><input type="text" class="size3" name="coordinator" placeholder="Name" data-validate="alpha,required"><br/>
								</td></tr>
								<tr><td style="width:240px;"><label>Name of Co-Coordinator:</label></td>
								<td><input type="text" class="size3" name="cocoordinator"placeholder="Name" data-validate="alpha"><br/>
								</td></tr>
								<tr><td style="width:240px;"><label>Name of Organizing Committee:</label></td>
								<td><input type="text" class="size3" name="organisers" placeholder="Name" data-validate="alpha"><br/>
								</td></tr>
...
student <input type="radio" onclick="javascript:yesnoCheck();" name="participant" value="student" id="stud"/>
 faculty <input type="radio" onclick="javascript:yesnoCheck();" name="participant"value="faculty" id="fac"/><br/>
...
<tr><td style="width:150px;"><label>Participants from:</label></td><td><input type="text" class="size3"  value="" data-role="tagsinput" data-validate="alpha,required"/></td>
                    </tr>									</table>	
...
<fieldset>
								<div id="room_fileds">
									...
									<div class="content">
										Name of Speaker: <input type="text" data-validate="alpha,required" name="s1name" class="size3"/><br/>
