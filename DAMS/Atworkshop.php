...
<html>
 ...
 {
      $(".data").load("Atworkshop.php");// a function which will load data from other file after x seconds
  }

  setInterval('autoRefresh_div()', 2);</script>
	</head>
	<body>
		<header>
		</header>
		...
		<div class="frame">
				<div class="data">
			<div id="style1">
			<center>Attended Workshop Programmes				</center></div>
			<div class="left">
		
			<input type="button" onclick="TINY.box.show({iframe:'iawork.php',boxid:'frameless',width:850,height:550,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS()}})"class="link1 id="menu_active"" value="Insert New Data">
			</div>			
			<div class="right">
	...
	-->		<input type="button" onclick="window.open('examples/pdf2.php')" value="Download pdf">
