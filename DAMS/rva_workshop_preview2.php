...
<?php
	 ...
	 include ('rva_navigation.php'); 
	    echo '
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			  ...
			  <h4 class="page-header"><center>Organized Workshop Report</center></h4>';
									...
									<tbody>';
									if(($range==1)||($range==2))
                                        $res=mysqli_query($con,"Select * from organisedwork where w_date BETWEEN '$from' AND '$to'");
                                    else
                                        $res=mysqli_query($con,"Select * from organisedwork order by w_date asc");
									$i=1;
	...
	else if($_GET['submit']==2)
	{
		...
		header("Content-Disposition: attachment; filename=Oragnized-Workshop-Report.xls");
