			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			  ...
			  <h4 class="page-header"><center>Workshop Report</center></h4>
						...
						<?php
								...
								if(($range==1)||($range==2))
									$res=mysqli_query($con,"Select * from workshop where w_date BETWEEN '$from' AND '$to' order by username asc");
								else
									$res=mysqli_query($con,"Select * from workshop order by username asc");
								$i=1;
								$count=0;
								while($row=mysqli_fetch_array($res))
								{
									...
									if($fc==0)
									{
										...
										if(($range==1)||($range==2))
											$ress=mysqli_query($con,"Select * from workshop where w_date BETWEEN '$from' AND '$to' AND username='$un'");
										else
											$ress=mysqli_query($con,"Select * from workshop where username='$un'");
