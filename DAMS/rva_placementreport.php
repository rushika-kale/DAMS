  ...
  <head>
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Placement Report</h1>
		  <h4></h4>
						...
						<form name="myform" action="rva_placementreport_preview.php" method="post">
						...
						<tbody>
							...
							<tr>
								<th>UG</th>
								<td>
										<div class="checkbox"><label><input type="checkbox" name="ug"></label></div>
								</td>
							</tr>
							<tr>
								<th>PG</th>
								<td>
										<div class="checkbox"><label><input type="checkbox" name="pg"></label></div>
								</td>
							</tr>
							<tr>
								<th>Package</th>
								<td>
										<div class="checkbox"><label><input type="checkbox" name="pkg"></label></div>
								</td>
							</tr>
							<tr>
								<th>Uncheck All:</th>
