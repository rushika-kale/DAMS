	...
	<script src="js/jquery.min.js"></script>
		<script>
									...
									<script type="text/javascript">
												function DoAll()
												{
													document.myform.event.checked = true;
												...
												function UndoAll()
												{
													document.myform.event.checked = false;
												...
												function cuncheck()
												{
													if(document.myform.event.checked==true || 
													document.myform.name.checked==true || 
													document.myform.place.checked == true ||
													document.myform.date.checked == true ||
													document.myform.days.checked == true)								
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  ...
		  <h4></h4>
						...
						<form name="myform" action="rva_atten_all_preview.php" method="post">
						...
						<tbody>
							...
							<tr>
								<th>Type of Event:</th>
								<td>
										 <div class="checkbox"><label><input type="checkbox" name="event" onclick="cuncheck()"></label></div>
								</td>
							</tr>
							<tr>
								<th>Name of Event:</th>
						...
						<nav>
							<ul class="pager">
								...
								<a href="rva_all_excel_1_A.php" class="btn btn-info" role="button">Excel Download</a>
							</ul>
						</nav>
						</form>
