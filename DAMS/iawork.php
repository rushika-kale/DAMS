...
<script> $.validate({
  ...
  addValidClassOnAll : true
	...
	<body>
		<form name="data" action="insertty.php"  enctype="multipart/form-data" method="post">
			<label>Name<font color="red">*</font></label>
			<input type="text" class="size4" name="wname" data-validate="alpha,required" placeholder="Enter Workshop Name"><br/>
		
		<label>Select Session: </label><select name="session">
...
function daydiff(first, second) {
    return (second-first)/(1000*60*60*24);
			...
			<br/><label>No. of days of Workshop<font color="red">*</font></label>
			...
			<br/><label>Place of Workshop<font color="red">*</font></label>
			<input type="text" class="size3" name="wvenue"  placeholder="Place name"data-validate="required"><br/>
			<label>Registration fees:<font color="red">*</font></label>
			<input type="text" class="size3" name="regfees"  placeholder="Rs." data-validate="number,required"><br/>
			...
			/*$image = mysql_fetch_array(mysql_query("SELECT wattach1 FROM  faculty.workshop where username='$username' &&wname='$wname'"));
			...
			$image=$image['wattach1'];	
				echo"<font color='blue'>already uploaded</font>&nbsp;&nbsp;&nbsp;";
								...
								$image = mysql_fetch_array(mysql_query("SELECT wattach2 FROM  faculty.workshop where username='$username'"));
				...
				echo"<font color='blue'>already uploaded</font>&nbsp;&nbsp;&nbsp;";
							...
							$image = mysql_fetch_array(mysql_query("SELECT wattach3 FROM  faculty.workshop where username='$username'"));
