...
// Logo
    ...
    // Title
    $this->Cell(90,7,$dept,0,'L',0);
    // Line break
$this->Image($image,160,15,30);
	//1
    $this->Ln(40);
...
$this->Cell(30,8,'Ph.D',1,0,'L',0);
	...
	$this->Ln();
$this->Cell(70,8,'Class/ Grade','LRB',0,'C',0);  // cell with left and right borders
...
$this->Cell(30,8,'Research',1,0,'L',0);
	...
	$this->Ln();
$this->Cell(70,8,' In Years','LRB',0,'C',0);  // cell with left and right borders
...
$this->Cell(60,8,'International- 4','LTR',0,'L',0);
	...
	$this->Ln();
$this->Cell(70,8,'in Conferences','LRB',0,'C',0);  // cell with left and right borders
$this->Cell(60,8,' ','LRB',0,'L',0);
$this->Cell(60,8,' ','LRB',0,'L',0);
...
$this->Cell(70,13,'Professional Institution','LRB',0,'C',0);  // cell with left and right borders
