...
<?php
	...
	echo'
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			  ...
			  <h4 class="page-header"><center>Organized Seminar Report</center></h4>';
									...
									if(($range==1)||($range==2))
									{
											$res=mysqli_query($con,"select * from organisedsem where w_date BETWEEN '$from' AND '$to'");
									}
									else
									{
										$res=mysqli_query($con,"select * from organisedsem");
									}
									echo '</tr>
									</thead>
									<tbody>';
	...
	else if($_GET['submit']==2)
	{
		...
		header("Content-Disposition: attachment; filename=Oragnized-Seminar-Report.xls");
		...
		echo '<table border="1">
									...
									//$res=mysqli_query($con,"select * from organisedsem where session='$session2012_13' or session='$session2013_14' or session='$session2014_15' or session='$session2015_16'");
									if(($range==1)||($range==2))
									{
											$res=mysqli_query($con,"select * from organisedsem where w_date BETWEEN '$from' AND '$to'");
									}
