...
$username=$_SESSION['username1'];	
			...
			?>
		<form  class="form" action="notifier.php"  method="post" enctype="multipart/form-data">
<center>Notification Title:<input type="text" class="size4" name="ntitle" data-validate="required" /><br />
Notification Notice:<input type="text" class="size4" name="ntext" data-validate="required" /><br />
Upload Attachment:<input type="file" name="file" id="file" /><br /><font size="1">Upload size limit 2mb and format doc,docx,pdf </font><br />
