...
<html>
	...
	<body>
		...
		<div class="frame">
				<div class="data">
			<div id="style1">
			<center>Attended STTP Programmes				</center></div>
			<div class="left">
		
			<input type="button" onclick="TINY.box.show({iframe:'iasttp.php',boxid:'frameless',width:850,height:550,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS()}})"class="link1 id="menu_active"" value="Insert New Data">
			</div>			
			<div class="right">
	...
	-->		<input type="button" onclick="window.open('examples/pdf60.php')" value="Download pdf">
...
$db=mysql_select_db("faculty",$con) or die("Failed to connect to MySQL: " . mysql_error());	
$username=$_SESSION['username1'];	
			$result = mysql_query("SELECT * FROM sttp WHERE username='$username'");
