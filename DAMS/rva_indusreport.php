  ...
  <head>
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Industrial Visit Report</h1>
		  <h4></h4>
						...
						<form name="myform" action="rva_indus_preview.php" method="post">
						...
						<tbody>
							...
							<tr>
								<th>Location:</th>
								<td>
										 <div class="checkbox"><label><input type="checkbox" name="vloc" onclick="cuncheck()"></label></div>
								</td>
							</tr>
							<tr>
								<th>Date:</th>
							...
							<tr>
								<th>Year/Sem:</th>
								<td>
										 <div class="checkbox"><label><input type="checkbox" name="yearsem" onclick="cuncheck()"></label></div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<th>Fees:</th>
								<td>
										 <div class="checkbox"><label><input type="checkbox" name="fee" onclick="cuncheck()"></label></div>
								</td>
							</tr>
							<tr>
								<th>Mode Of Travel:</th>
								<td>
										 <div class="checkbox"><label><input type="checkbox" name="mode" onclick="cuncheck()"></label></div>
								</td>
							</tr>
