...
$rowa = mysql_fetch_array($sqla,MYSQL_BOTH);
     echo 'Seminar attended by'.$rowa['sal'].' '.$rowa['f_name'].' '.$rowa['LEFT(m_name,1)'].'. '.$rowa['l_name']; ?>
...
$select_query = "SELECT username,wname,wvenue,w_date FROM  faculty.seminar where username='$username'";
