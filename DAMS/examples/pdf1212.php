...
$select_query = "SELECT * FROM  faculty.organisedsttp where username='$username'";
...
<br/><b>Report On Organised STTP by <?php 
...
?>
            ...
            <tr>
                ...
                <td style="width: 40%; text-align: left; border: solid 1px #000;padding-left: 8px;">
                    Event Name
				 </td>
