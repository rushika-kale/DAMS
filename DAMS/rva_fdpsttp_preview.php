...
<?php
	...
	if($_POST['tarea'])
		...
		$tarea=0;
	header("Location:rva_fdpsttp_preview2.php?submit=$submit&range=$range&from=$from&to=$to&name=$name&tevent=$tevent&nevent=$nevent&nspeaker=$nspeaker&date=$date&days=$days&npart=$npart&agency=$agency&tarea=$tarea");
