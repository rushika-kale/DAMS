	...
	while($data = mysqli_fetch_assoc($sql))
	{
		...
		if($fc==0)
		{
			$ress=mysqli_query($con,"
								Select userid,username,wname,wvenue,w_date,w_date2 from workshop where username='$un'
								union
								Select userid,username,wname,wvenue,w_date,w_date2 from seminar where username='$un'
								union
								Select userid,username,wname,wvenue,w_date,w_date2 from fdp where username='$un'
								union
								Select userid,username,wname,wvenue,w_date,w_date2 from sttp where username='$un'");
