...
$fname=mysqli_fetch_array(mysqli_query($con,"SELECT f_name FROM faculty.profile WHERE username='$username'"));
$fname=mysqli_fetch_array(mysqli_query($con,"SELECT f_name FROM faculty.profile WHERE username='$username'"));
								if (isset($fname['f_name'])  AND !empty($fname['f_name']))
									$fname=$fname['f_name'];
								else 
									$fname="First Name";
$image = mysqli_fetch_array(mysqli_query($con,"SELECT images_path FROM  faculty.facimg where username='$username'"));
...
<div class="wrap"> </br></br></br>
	<!--<div class="header-top">
	        <div class="logo">
			 ...
			 <img src="images/ycce.png" style="display:none;" width="400" height="65" alt=""/></br></br>
		     <div class="h_menu4" ><!-- start h_menu4 -->
				...
				<ul class="nav" >
					...
					<li><a href="#">Events</a>
						<ul>
							<li class="active"><a href="rva_add_organized.php">Organized</a></li>
							<!--<li><a href="rva_add_workshop.php">&nbsp;&nbsp;&nbsp;&nbsp;Workshop</a></li>
							<li><a href="rva_add_seminar.php">&nbsp;&nbsp;&nbsp;&nbsp;Seminar</a></li>
							<li><a href="rva_add_fdp_sttp.php">&nbsp;&nbsp;&nbsp;&nbsp;FDP/STTP</a></li>
							...
							<li class="active"><a href="rva_add_atten.php"><strong>Attended</strong></a></li>
						<!--	<li><a href="rva_add_atten_workshop.php">&nbsp;&nbsp;&nbsp;&nbsp;Workshop</a></li>
							<li><a href="rva_add_atten_seminar.php">&nbsp;&nbsp;&nbsp;&nbsp;Seminar</a></li>
							<li><a href="rva_add_atten_fdp_sttp.php">&nbsp;&nbsp;&nbsp;&nbsp;FDP/STTP</a></li>
					...
					<li ><a href="#">Miscellaneous</a>
						<ul>
							<li><a href="rva_add_publi.php">Add Publication</a></li>
							<li><a href="">Delete/Edit</a></li>
							<li><a href="rva_add_funproject.php">Funding Projects</a></li>
							<li><a href="rva_bug.php">Report a bug</a></li>
							<li><a href="rva_bug_preview.php">View bug report</a></li>
						</ul>
					</li>
