...
<html>
<head>
<title>Welcome to E-Resource Support System</title>
...
<div class="wrap"> 
	<div class="header-top">
	        <div class="logo">
		     ...
		     <center><img src="head1.jpg"  alt=""/><center>
			 <div class="h_menu4"><!-- start h_menu4 -->
				...
				<ul class="nav">
					...
					<li><a href="shortcodes.html">Events</a>
						<ul>
					...
					<li><a href="blog.html">Publications</a>
						<ul>
							<li><a href="">Add</a></li>
					...
					if($ac['access']==1)
					echo '
					<li><a href="portfolio.html">Admin</a>
						<ul>
					...
					<li><img src="<?php echo $image;?>" width="65" height="65" alt=""/>
					<ul>
        ...
        <div class="slider">
			  ...
			  <div id="da-slider" class="da-slider">
				  ...
				  <?php
				  $res=mysql_query("Select * from notifier order by userid desc");
				  ...
				  <div class="da-slide">
					<h1>'.$row['title'].'</h1>
					<p>'.$row['text'].'</p>
					<a href="notifiles/'.$row['filename'].'" class="da-link">Download</a>
				  </div>';
				  }
				  ?>
				  <!--<div class="da-slide">
	 ...
	 <div class="main">
		 ...
		 <div class="m_3"><span class="left_line"></span>E-Resource support System<span class="right_line"> </span></div>
		      <div class="wmuSlider example">
			    <div class="wmuSliderWrapper">
				   <article style="position: absolute; width: 100%; opacity: 0;"> 
				   	   <div class="banner-text">
						  <p>E-Resource Spport System is designed to minimize and manage all the paper work that is to be done in department by faculty as well as students.It provides you a automated mechanism like report generation and faculty profile management at single server.</p>
					   </div>
					   <h3 class="m_6">About E-Resource Support System <span class="bg1"></span></h3>
				   </article>
