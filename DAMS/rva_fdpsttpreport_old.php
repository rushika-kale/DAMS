		  ...
		  <h4></h4>
						...
						<tbody>
							...
							<tr>
								<th>2012-13</th>
								<td>
										<div class="checkbox"><label><input type="checkbox" name="s2012_13" onclick="Scuncheck()"></label></div>
								</td>
							</tr>
							<tr>
								<th>2013-14</th>
								<td>
										<div class="checkbox"><label><input type="checkbox" name="s2013_14" onclick="Scuncheck()"></label></div>
								</td>
							</tr>
							<tr>
								<th>2014-15</th>
								<td>
										<div class="checkbox"><label><input type="checkbox" name="s2014_15" onclick="Scuncheck()"></label></div>
								</td>
							</tr>
							<tr>
								<th>2015-16</th>
								<td>
										<div class="checkbox"><label><input type="checkbox" name="s2015_16" onclick="Scuncheck()"></label></div>
								</td>
							</tr>
							<tr>
