...
<script> $.validate({
  ...
  addValidClassOnAll : true
	...
	<body>
		<form name="data" action="inserttysem.php"  enctype="multipart/form-data" method="post">
			<label>Name<font color="red">*</font></label>
			<input type="text" class="size4" name="wname" placeholder="Enter seminar Name" data-validate="alpha,required"><br/>
...
function daydiff(first, second) {
    return (second-first)/(1000*60*60*24);
           ...
           To: <input type="text"name="edate" id="to"data-validate="required"/>
			...
			<br/><label>No. of days of seminar<font color="red">*</font></label>
	<input type="text" name="days" id="days" readonly>
			...
			<br/><label>Place of seminar<font color="red">*</font></label>
			...
			/*$image = mysql_fetch_array(mysql_query("SELECT wattach1 FROM  faculty.seminar where username='$username' &&wname='$wname'"));
			...
			$image=$image['wattach1'];	
				echo"<font color='blue'>already uploaded</font>&nbsp;&nbsp;&nbsp;";
								...
								$image = mysql_fetch_array(mysql_query("SELECT wattach2 FROM  faculty.seminar where username='$username'"));
				...
				echo"<font color='blue'>already uploaded</font>&nbsp;&nbsp;&nbsp;";
							...
							$image = mysql_fetch_array(mysql_query("SELECT wattach3 FROM  faculty.seminar where username='$username'"));
