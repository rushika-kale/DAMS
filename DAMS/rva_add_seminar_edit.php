...
<?php
	...
	if(isset($_GET['ename']) AND !empty($_GET['place'])AND isset($_GET['username']) )
	{
		$ename=$_GET['ename'];
		$place=$_GET['place'];
		$usernamee=$_GET['username'];
		$res=mysqli_query($con, "select *  from seminar where username='$usernamee' && wname='$ename'&& wvenue='$place'");
...
<form name="myform" role="form" action="rva_add_seminar1.php" method="post">		
						  ...
						  <div id="collapse1" class="panel-collapse collapse in">
							...
							<div class="form-group">
								...
								<div class="form-group">
								  ...
								  <input type="text" name="namepr" value="<?php echo $row['wname'];?>"class="form-control" placeholder="Seminar name" id="namepr" required>
								</div>
								<div class="form-group">
